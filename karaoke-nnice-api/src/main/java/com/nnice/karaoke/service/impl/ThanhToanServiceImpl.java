...
public class ThanhToanServiceImpl implements ThanhToanService {
    ...
    private ThanhToanResponse convertToResponse(HoaDon hoaDon) {
        return ThanhToanResponse.builder()
                ...
                .maPhieuSuDung(hoaDon.getPhieuSuDung() != null ? hoaDon.getPhieuSuDung().getMaPhieuSuDung() : null)
                .maKH(hoaDon.getKhachHang() != null ? hoaDon.getKhachHang().getMaKH() : null)
                .ngayLap(hoaDon.getNgayLap())
                .tienPhong(hoaDon.getTienPhong() != null ? hoaDon.getTienPhong() : BigDecimal.ZERO)
                .tienAnUong(hoaDon.getTienDichVu() != null ? hoaDon.getTienDichVu() : BigDecimal.ZERO)
